...
class SearchPage(BasePage):
    ...
    def search(self, query: str):
        ...
        self.page.get_by_test_id("searchbox-form").locator("button").filter(has_text="Поиск").click()
        return self
    
    def expect_search_results(self):
        expect(self.page.locator("a[data-testid='result-extras-site-search-link']").first).to_be_visible()
        return self
