...
class ContactSalesPage(BasePage):
    ...
    def expect_form_filled(self, first_name: str, last_name: str):
        expect(self.page.get_by_role("textbox", name="First name")).to_have_value(first_name)
        expect(self.page.get_by_role("textbox", name="Last name")).to_have_value(last_name)

    # def get_filled_values(self) -> tuple[str, str]:
    #     return self.first_name_input.input_value(), self.last_name_input.input_value()
